...
declare const DateTimeSchema: z.ZodPipe<z.ZodUnion<readonly [z.ZodCustom<DateTime<boolean>, DateTime<boolean>>, z.ZodPipe<z.ZodDate, z.ZodTransform<DateTime<true> | DateTime<false>, Date>>]>, z.ZodCustom<DateTime<boolean>, DateTime<boolean>>>;
...
declare const MessageDTO: z$1.ZodObject<{
    id: z$1.ZodUUID;
    type: z$1.ZodEnum<{
        TEXT: "TEXT";
        IMAGE: "IMAGE";
    ...
    createdAt: z$1.ZodPipe<z$1.ZodUnion<readonly [z$1.ZodCustom<luxon.DateTime<boolean>, luxon.DateTime<boolean>>, z$1.ZodPipe<z$1.ZodDate, z$1.ZodTransform<luxon.DateTime<true> | luxon.DateTime<false>, Date>>]>, z$1.ZodCustom<luxon.DateTime<boolean>, luxon.DateTime<boolean>>>;
    updatedAt: z$1.ZodNullable<z$1.ZodPipe<z$1.ZodUnion<readonly [z$1.ZodCustom<luxon.DateTime<boolean>, luxon.DateTime<boolean>>, z$1.ZodPipe<z$1.ZodDate, z$1.ZodTransform<luxon.DateTime<true> | luxon.DateTime<false>, Date>>]>, z$1.ZodCustom<luxon.DateTime<boolean>, luxon.DateTime<boolean>>>>;
    senderId: z$1.ZodUUID;
}, z$1.core.$strip>;
type MessageDTO = z$1.infer<typeof MessageDTO>;
